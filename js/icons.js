...
(function () {
  const ICONS = {
    ...
    settings: '<circle cx="12" cy="12" r="3"/><path d="M19 15c.4.7.3 1.6-.3 2.2l-.1.1a2 2 0 1 1-2.8 2.8l-.1-.1c-.6-.6-1.5-.7-2.2-.3-.7.3-1.1 1-1.1 1.8V22a2 2 0 1 1-4 0v-.1c0-.8-.4-1.5-1.1-1.8-.7-.4-1.6-.3-2.2.3l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1c.6-.6.7-1.5.3-2.2-.3-.7-1-1.1-1.8-1.1H2a2 2 0 1 1 0-4h.1c.8 0 1.5-.4 1.8-1.1.4-.7.3-1.6-.3-2.2l-.1-.1A2 2 0 1 1 6.3 4l.1.1c.6.6 1.5.7 2.2.3.7-.3 1.1-1 1.1-1.8V2a2 2 0 1 1 4 0v.1c0 .8.4 1.5 1.1 1.8.7.4 1.6.3 2.2-.3l.1-.1A2 2 0 1 1 20 6.3l-.1.1c-.6.6-.7 1.5-.3 2.2.3.7 1 1.1 1.8 1.1H22a2 2 0 1 1 0 4h-.1c-.8 0-1.5.4-1.8 1.1z"/>',
  ...
  const EMOJI_TO_ICON = {
    ...
    "🔔": "bell", "➕": "plus", "👥": "users", "⚙️": "settings", "🏪": "store",
