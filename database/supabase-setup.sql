-- ValiSys - Estrutura inicial para Supabase
-- Rode este arquivo no Supabase > SQL Editor.
-- Esta é a FASE 1: banco online para sincronizar celulares.
-- Observação: as policies abaixo estão simples para protótipo.
-- Na versão comercial final, use Supabase Auth + RLS por loja.
...
-- Produtos cadastrados ou puxados da API
...
-- Para protótipo rápido, você pode deixar as tabelas sem RLS enquanto testa.
-- Para vender/comercializar, ative RLS e use Supabase Auth.

-- Exemplo de ativação futura de RLS:
